  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.rightHalf}>
        ...
        <p>Our platform is dedicated to connecting exceptional students from top-tier universities with leading employers worldwide. At Jazzee, we partner with prestigious educational institutions to ensure their students are placed in roles where they can thrive and grow.</p>
        <p>Employers gain access to a rich pool of talent from renowned colleges, tailored to meet their hiring needs. This partnership empowers organizations to discover top candidates who are not only qualified but also aligned with their values and culture.</p>
        <p>Students, in turn and benefit from personalized guidance. Together, we create a dynamic ecosystem that drives success for students, universities, and employers.</p>
      </div>
    </div>
  );
}
